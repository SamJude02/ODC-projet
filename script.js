...
document.getElementById("formulaire").addEventListener("submit", function(e) {
  ...
  if (!nom || !prenom || !email || !mdp || !confirmer || !adresse) {
  ...
  if (erreurs.length > 0) {
    ...
    messageErreur.innerHTML = "Formulaire valide ! Envoi en cours...";
    
    // ici tu peux envoyer le formulaire (ex: via AJAX ou e.target.submit())
    // ou simplement réinitialiser le formulaire :
    // e.target.reset();
  }
});


// =============================== ANIMATION SECTION NOS PRODUITS =========================
